...
(function (root) {
  ...
  var UI = {
    fa: {
      ...
      badgeTitle: "نمایش بَج",
      stBadge: "بَج کنار قیمت",
      stSub: "زیر قیمت",
      stCompact: "فشرده (K/M)",
      stHover: "فقط با نگه‌داشتن ماوس",
      colorTitle: "رنگ",
      cGreen: "سبز",
      cTeal: "فیروزه‌ای",
      cAmber: "کهربایی",
    ...
    en: {
      ...
      badgeTitle: "Badge style",
      stBadge: "Next to price",
      stSub: "Under price",
      stCompact: "Compact (K/M)",
      stHover: "Only on hover",
      colorTitle: "Color",
      cGreen: "Green",
      cTeal: "Teal",
      cAmber: "Amber",
    ...
    es: {
      ...
      badgeTitle: "Estilo de insignia",
      stBadge: "Junto al precio",
      stSub: "Bajo el precio",
      stCompact: "Compacto (K/M)",
      stHover: "Solo al pasar el ratón",
      colorTitle: "Color",
      cGreen: "Verde",
      cTeal: "Turquesa",
      cAmber: "Ámbar",
    ...
    de: {
      ...
      badgeTitle: "Badge-Stil",
      stBadge: "Neben dem Preis",
      stSub: "Unter dem Preis",
      stCompact: "Kompakt (K/M)",
      stHover: "Nur bei Hover",
      colorTitle: "Farbe",
      cGreen: "Grün",
      cTeal: "Türkis",
      cAmber: "Bernstein",
    ...
    it: {
      ...
      badgeTitle: "Stile badge",
      stBadge: "Accanto al prezzo",
      stSub: "Sotto il prezzo",
      stCompact: "Compatto (K/M)",
      stHover: "Solo al passaggio",
      colorTitle: "Colore",
      cGreen: "Verde",
      cTeal: "Turchese",
      cAmber: "Ambra",
    ...
    ro: {
      ...
      badgeTitle: "Stilul insignei",
      stBadge: "Lângă preț",
      stSub: "Sub preț",
      stCompact: "Compact (K/M)",
      stHover: "Doar la hover",
      colorTitle: "Culoare",
      cGreen: "Verde",
      cTeal: "Turcoaz",
      cAmber: "Chihlimbar",
